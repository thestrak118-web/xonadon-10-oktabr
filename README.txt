...
Har bir papka mustaqil statik hostingda ishlaydi. Lokal: python3 -m http.server 8000.
Sahifa pastidagi ism/+998 formasi va thankYou.html tayyor. Yuqoridagi tugma formaga olib boradi. Har bir js/config.js ga shu loyiha uchun endpointUrl,
telegramUrl, pixelId va sheetName kiriting. Avvalgi kampaniya qiymatlari ko‘chirilmagan.
Valid ism/telefon: darhol thank-you; ariza fonda yuboriladi. Xatoda retry ishlaydi.
FormData: Ism, Telefon raqam, Royhatdan o'tgan vaqti, ixtiyoriy sheetName.
Server HTTP2xx va JSON ok:true / success:true / status:success / result:success tasdig‘i kerak.
